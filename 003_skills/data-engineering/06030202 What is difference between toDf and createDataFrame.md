...
> [!Summary] Summary
> 
> - Both to `.toDf()` and `createDataFrame()` are used to create a Dataframe.
> - Usually to `.toDf()` is used to convert RDD to a data Frame.
> - `createDataFrame()` is used to create data frame using a list, pandas df, itterable
> 
